...
#define UE_PROJECT_NAME MinesweeperClone
#define UE_TARGET_NAME MinesweeperCloneEditor
#define UE_MODULE_NAME "MinesweeperClone"
...
#define MINESWEEPERCLONE_API DLLEXPORT
